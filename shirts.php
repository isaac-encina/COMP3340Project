...
<div class="content-wrapper">
    ...
    <main class="about-main">
        <h1>Shirts</h1>
        <p class="about-text">Look at our shirts.</p>
        <div class="product-grid">
            <?php
            $stmt = $conn->query("SELECT * FROM ITEMS where category = 'shirt'"); //gets all items that are in the shirt categories, for display.
            $items = $stmt->fetchAll();

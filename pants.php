...
<div class="content-wrapper">
    ...
    <main class="about-main">
        <h1>Pants</h1>
        <p class="about-text"> Look at our pants.</p>
        <div class="product-grid">
            <?php
            $stmt = $conn->query("SELECT * FROM ITEMS where category = 'pants'"); //gets all items that are in the hoodie categories, for display.
            $items = $stmt->fetchAll();
